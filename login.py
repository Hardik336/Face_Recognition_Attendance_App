...
class Loin_Window:
    def __init__(self, root):
        ...
        # Frame for login
        frame = Frame(self.root, bg="#1E3D59", bd=5, relief=RIDGE)  # Navy blue color
        frame.place(x=610, y=170, width=340, height=450)

        # Rounded button style
        def on_enter(e):
            e.widget['background'] = '#0B3D91'  # Darker blue on hover
        def on_leave(e):
            e.widget['background'] = '#1E90FF'  # Lighter blue
        ...
        lblimg1 = Label(image=self.photoimage1, bg="#1E3D59", borderwidth=0)
        lblimg1.place(x=730, y=175, width=100, height=100)

        # Title
        get_str = Label(frame, text="Get Started", font=("Helvetica", 20, "bold"), fg="white", bg="#1E3D59")
        get_str.place(x=95, y=100)

        # =========== Labels and Entries ===========
        # Username Label and Entry
        username = Label(frame, text="Username", font=("Helvetica", 15, "bold"), fg="white", bg="#1E3D59")
        username.place(x=70, y=145)
        self.txtuser = ttk.Entry(frame, font=("Courier", 15))
        self.txtuser.place(x=40, y=180, width=270)

        # Password Label and Entry
        password_lbl = Label(frame, text="Password", font=("Helvetica", 15, "bold"), fg="white", bg="#1E3D59")
        password_lbl.place(x=70, y=215)
        self.txtpassword = ttk.Entry(frame, font=("Helvetica", 15), show="*")
        ...
        lblimg2 = Label(image=self.photoimage2, bg="#1E3D59", borderwidth=0)
        ...
        lblimg3 = Label(image=self.photoimage3, bg="#1E3D59", borderwidth=0)
        lblimg3.place(x=650, y=394, width=25, height=25)

        # Login Button
        loginbtn = Button(frame, text="Login", command=self.login, font=("Helvetica", 15, "bold"), bd=3, relief=RIDGE, fg="white", bg="#1E90FF", activeforeground="white", activebackground="#1E90FF")
        loginbtn.place(x=110, y=300, width=120, height=35)
        loginbtn.bind("<Enter>", on_enter)
        loginbtn.bind("<Leave>", on_leave)

        # Register Button
        registerbtn = Button(frame, text="New User Register", command=self.register_window, font=("Helvetica", 10, "bold"), borderwidth=0, fg="white", bg="#1E3D59", activeforeground="white", activebackground="#1E3D59")
        registerbtn.place(x=15, y=350, width=160)

        # Forgot Password Button
        Fpasswordbtn = Button(frame, text="Forget Password", command=self.forgot_password_window, font=("Helvetica", 10, "bold"), borderwidth=0, fg="white", bg="#1E3D59", activeforeground="white", activebackground="#1E3D59")
...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        # # Background Image
        img3=Image.open(r"C:\Users\hardik\OneDrive\Documents\Desktop\Face_Recognition_System\1628243597666college-images\college_images\bg.jpg")
        ...
        # Photos Button
        img9=Image.open(r"C:\Users\hardik\OneDrive\Documents\Desktop\Face_Recognition_System\1628243597666college-images\college_images\sample.jpg")
